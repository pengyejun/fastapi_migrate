...
class Migrate:
    def __init__(self, app=None, model=None, directory: str = 'migrations', db_uri: str = None, **kwargs):
    ...
    def init_app(self, app, model=None, directory: str = None, db_uri: str = None, **kwargs):
